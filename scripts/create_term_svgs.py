...
tmux_session_name = 'tmux_sync_nvim'
...
class InputThread(Thread):
    ...
    def run(self):
        try:
            ...
            tmux_killer = './tmux_kill.sh'
            os.system('{} {}'.format(tmux_killer, tmux_session_name))


InputThread().start()
tmux_sync = './tmux_sync.sh'
os.system('{} -c \'{} {} {} {}\' {}_capture.svg'.format(term_to_svg, tmux_sync, tmux_session_name,
                                                               editor_commands[0], editor_commands[1],
                                                               '_'.join(editor_commands)))
